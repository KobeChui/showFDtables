...
https://pubs.opengroup.org/onlinepubs/7908799/xsh/dirent.h.html for dirent.h, opendir, closedir, and readdir

https://man7.org/linux/man-pages/man0/unistd.h.0p.html for readlink
https://www.man7.org/linux/man-pages/man0/sys_stat.h.0p.html, https://man7.org/linux/man-pages/man2/stat.2.html for lstat, because I want the particular inode that a FD is pointing to, regardless if it is a soft or hard link

#define _GNU_SOURCE for readlink Piazza post @185

https://www.geeksforgeeks.org/snprintf-c-library/
snprintf to easily concatenate strings and integer

https://geeksforgeeks.org/printf-in-c for left alligning text



Only put PIDs with accessible FDs onto tables. 
If no FD is accessible from a PID, 